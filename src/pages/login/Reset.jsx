...
export default function ResetPassword() {
  ...
  const sendMobileOtp = async () => {
    ...
    try {
      ...
      setHasSentOTPOnce(true);    // shifted up for low network cases
  ...
  return (
    ...
    <>
      ...
      <AdminActionControl
        ...
        subtitle={'You successfully reset your password.'}
          ...
          {!resetPassword ? (
            ...
            <>
              ...
              <div className='px-4 py-3 md:p-0 w-full md:w-auto bg-white md:bg-transparent top-0'>
                ...
                <h2 className='text-primary-black font-semibold text-xl'>Reset password</h2>

                <p className='text-dark-grey font-normal text-xs md:text-sm mt-1 md:mt-0'>

                  Your new password must differ from the last five passwords and will expire in 90

...
import { uploadCsv } from '../../../global'; // Assuming this function is correctly imported
...
export default function BulkUpload() {
  ...
  const handleUpload = async () => {
    try {
      ...
      await uploadCsv(formData, options);
      setFile(null);
      setUploadProgress(0);
  ...
  return (
    <div className='max-w-screen-lg mx-auto mt-10 p-6 bg-white shadow-md rounded-lg flex'>
      <div className='flex-1'>
        ...
        <div className='mb-4'>
          {file && <progress value={uploadProgress} max='100' className='w-full' />}
        </div>
        <button

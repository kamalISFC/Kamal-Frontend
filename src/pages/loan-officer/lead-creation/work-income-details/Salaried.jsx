  ...
  export default function Salaried({ requiredFieldsStatus, setRequiredFieldsStatus }) {
    ...
    const handleDropdownChange = useCallback(
      async (value) => {
          ...
          const currentValue = values?.applicants?.[activeIndex]?.work_income_detail?.mode_of_salary;
        ...
        console.log("error updating mode_of_salary", error);
      }
    ...
    console.error("Failed to update company_name", error);
  });
            } else {
              editFieldsById(
                values?.applicants?.[activeIndex]?.work_income_detail?.id,
